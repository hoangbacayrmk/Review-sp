...
def get_mock_data(angle: str = ""):
    ...
    elif "phân tích" in angle_lower or "hardsell" in angle_lower or "chất liệu" in angle_lower or "bền bỉ" in angle_lower:
        intro = "Không cần hoa mỹ, anh chị em cứ nhìn thẳng vào chất liệu và độ hoàn thiện của con hàng này là hiểu ngay tại sao nó vượt trội hơn hẳn mấy sản phẩm cùng tầm giá trên thị trường."
    else:
